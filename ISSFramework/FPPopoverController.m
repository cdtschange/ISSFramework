...
-(id)initWithViewController:(UIViewController*)viewController
{
    ...
    if(self)
    {
        ...
        self.contentSize = CGSizeMake(160, 240); //default size
        ...
        _contentView.viewController = viewController;
        _viewController = nav;//[viewController retain];
...
-(void)presentPopoverFromPoint:(CGPoint)fromPoint
{
    ...
    //    CGPoint ppt = _contentView.relativeOrigin;
...
-(void)presentPopoverFromBarButtonItem:(UIBarButtonItem*)barButtonItem
{
    if ([barButtonItem isKindOfClass:[UIBarButtonItem class]])
    {
        ...
        [self presentPopoverFromView:targetView];
    }
}
