...
//        contentRect.size = CGSizeMake(self.bounds.size.width-20, self.bounds.size.height-FP_POPOVER_ARROW_HEIGHT-50);
...
//    {
//        contentRect.origin = CGPointMake(10, 40);        
//        contentRect.size = CGSizeMake(self.bounds.size.width-40, self.bounds.size.height-FP_POPOVER_ARROW_HEIGHT-30);
//        _titleLabel.frame = CGRectMake(10, 10, self.bounds.size.width-20, 20);           
//    }
//
...
-(void)setupViews
{
    ...
    if(_arrowDirection == FPPopoverArrowDirectionUp)
    {
        ...
        contentRect.size = CGSizeMake(self.bounds.size.width-20, self.bounds.size.height-FP_POPOVER_ARROW_HEIGHT-50+30);
        //        _titleLabel.frame = CGRectMake(10, FP_POPOVER_ARROW_HEIGHT+10, self.bounds.size.width-20, 20);        
    }
    else if(_arrowDirection == FPPopoverArrowDirectionDown)
    {
    ...
    else if(_arrowDirection == FPPopoverArrowDirectionRight)
    {
        contentRect.origin = CGPointMake(10, 10);        
        contentRect.size = CGSizeMake(self.bounds.size.width-40, self.bounds.size.height-FP_POPOVER_ARROW_HEIGHT-30);
        //        _titleLabel.frame = CGRectMake(10, 10, self.bounds.size.width-FP_POPOVER_ARROW_HEIGHT, 20);           
    }
    ...
    {
        float hh = 44.0f;//self.viewController.navigationController.navigationBar.frame.size.height;
        ...
        [self.viewController.navigationController.navigationBar setBackgroundColor:[UIColor clearColor]];
        ...
        switch (self.tint) 
        {
            ...
            {
                tintColor = [UIColor colorWithRed:0.1 green:0.1 blue:0.1 alpha:1.0];            
            }break;
            case FPPopoverLightGrayTint:
            {
                tintColor = [UIColor colorWithRed:0.3 green:0.3 blue:0.3 alpha:1.0]; 
            }break;
            case FPPopoverGreenTint:
            {
                tintColor = [UIColor colorWithRed:0.18 green:0.3 blue:0.03 alpha:1.0];
            }break;
            case FPPopoverRedTint:
            {
                tintColor = [UIColor colorWithRed:0.36 green:0.0 blue:0.09 alpha:1.0];
            }break;
            default:
            {
                tintColor = [UIColor colorWithRed:0.1 green:0.1 blue:0.1 alpha:1.0]; 
        ...
        self.viewController.navigationController.navigationBar.frame = CGRectMake(0, -1, contentRect.size.width, hh);
