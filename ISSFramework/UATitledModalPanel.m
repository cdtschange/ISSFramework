...
- (CGRect)contentViewFrame {
	...
	CGRect rect = CGRectMake(self.outerHMargin + self.innerHMargin,
							 self.outerVMargin + self.innerVMargin + y,
							 roundedRectFrame.size.width - 2*self.innerHMargin,
							 roundedRectFrame.size.height - y - 2*self.innerVMargin);
	return rect;
}
